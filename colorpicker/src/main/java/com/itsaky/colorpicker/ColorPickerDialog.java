...
public class ColorPickerDialog extends Dialog implements SeekBar.OnSeekBarChangeListener,
    ...
    TextWatcher {
         ...
         */
        public ColorPickerDialog(Activity activity, int alpha, int red, int green, int blue) {
            super(activity);
            withAlpha = true;
         ...
         * @param blue => blue value
         */
        public ColorPickerDialog(Activity activity, int red, int green, int blue) {
            super(activity);
            withAlpha = false;
            this.alpha = 255;
            this.red = validateColorValue(red);
         ...
         */
        public ColorPickerDialog(Activity activity, String hexColor) {
            super(activity);
            try {
